...
//<!-- Find GCD of two numbers -->
    ...
    function findGcd($a, $b){
        ...
        if($a > $b) return findGCD($a-$b, $b);  //$a%$b is direct approch of a-b and reduce some number of recirsion (52-10, 10) ..... reach (2,10) after 4 recusrion but (52%10, 10) give (2,10) in 1 step
